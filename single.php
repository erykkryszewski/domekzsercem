    ...
    <div class="two-box-promo">
        ...
        <div class="container">
            <div class="two-box-promo__wrapper">
                ...
                <div class="two-box-promo__column two-box-promo__column--left">
                    <?php echo apply_filters('the_title', $left_column_content,); ?>
                </div>
                ...
                <div class="two-box-promo__column two-box-promo__column--right">
                    <div class="two-box-promo__info">
                        ...
                        <div class="two-box-promo__item">
                            ...
                            <div class="two-box-promo__discount">
                                <?php echo apply_filters('the_title', $item['discount'],); ?>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
                    <div class="two-box-promo__cta">
                        <div class="two-box-promo__encourage-text"><?php echo apply_filters('the_title', $right_down_content); ?></div>
                        <?php if (!empty($button)): ?>
                        <a href="<?php echo esc_html($button['url']); ?>" class="button two-box-promo__button"><?php echo esc_html($button['title']); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="wyswig-content mt-50">
                <div class="container">
                    <div class="wyswig-content__wrapper"><?php echo apply_filters('the_title', $wyswig_content); ?></div>
                </div>
            </div>
            <?php endif; ?>
        </div>
