...
<div class="two-columns-icons">
	...
	<div class="container">
		<div class="two-columns-icons__wrapper">
			<?php if(!empty($title)):?><h2 class="two-columns-icons__title"><?php echo apply_filters('the_title',$title);?></h2><?php endif;?>
			<?php if(!empty($subtitle)):?><h3 class="two-columns-icons__subtitle"><?php echo apply_filters('the_title',$subtitle);?></h3><?php endif;?>
